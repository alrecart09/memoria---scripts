...
for sujeto in participantes:
    ...
    path_ventana = path +'/señales_baseline/'+ sujeto + '/ventanasU/' + str(t) +  '/'    
    path_ccs = fn.makedir2(path +'/señales_baseline/'+ sujeto, 'caracteristicas/' + str(t) )
    ...
    for ventana in listaVentanas:
        ...
        vent.append(ventana)
        #print('len act ' + str(len(actividades)) )
        #print('len vent ' + str(len(vent)))
    ...
    #print('post drop HR len act ' + str(len(actividades)) )
    #print('post drop HR len vent ' + str(len(ventanas)))
    ...
    ventanas = pd.DataFrame(ventanas).drop(indices_nullPupila)
        #print('post borrar Pupila len act ' + str(len(actividades)) )
        #print('post borrar pupila len vent ' + str(len(ventanas)))
    #else:
